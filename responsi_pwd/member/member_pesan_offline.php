            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $sql_sel = "select * from transaksi where ((status='Menunggu Pembayaran' or status='Belum Lunas' or status='Lunas' or status='Dibatalkan') and jenis_bayar = 'cod') and username_member='$username' ";
                    ...
                    <div>
                        <form method="POST" action="">
                            <a href="cetak_bukti.php" type="button" class="btn btn-danger">Cetak</a>
                            <a href="bukti_xml.php" type="button" class="btn btn-warning">XML</a>
                            <a href="bukti_json.php" type="button" class="btn btn-success">JSON</a>
                        </form>
                    </div>
                </div>
            </div>
