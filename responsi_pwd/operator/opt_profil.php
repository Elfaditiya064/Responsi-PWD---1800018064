  ...
  <body>
    ...
    if (isset($_GET['lap'])) {
      if ($_GET['lap'] == "delete") {
        ...
        mysqli_query($koneksi, "delete from lapangan where id_lap = '$_GET[id_lap]'");
      ...
      <div class="panel panel-default">
                ...
                ?>
                  <tr>
                    ...
                    <td class="center">
                      ...
                      <a href="#" onClick="confirm_modal('lap_pro_del.php?&id_lap=<?php echo $sql_res['id_lap']; ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>
                    </td>
        ...
        <div class="panel-heading">
          <form method="POST" action="">
            <a href="akses_data.php" type="button" class="btn btn-danger">Akses Data</a>
          </form>
        </div>
      </div>
